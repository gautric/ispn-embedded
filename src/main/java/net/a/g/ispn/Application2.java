...
//   private static final String INFINISPAN_CONFIGURATION = "infinispan-clustered-tcp.xml";
   ...
   public void counter() {
      ...
      StrongCounter aCounter = counterManager.getStrongCounter("counter");
   ...
   public class MyListener {
      ...
      public void printDetailsOnChange(CacheEntryEvent e) {
         System.out.printf("Thread %s has modified an entry in the cache named %s under key %s  == %s !\n",
               Thread.currentThread().getName(), e.getCache().getName(), e.getKey(), e.getValue());
      }
